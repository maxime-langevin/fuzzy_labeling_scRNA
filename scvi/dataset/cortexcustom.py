...
class CortexDatasetCustom(GeneExpressionDataset):
    ...
    def __init__(self, corruption_probabilities=[0, 0], save_path='data/', genes_to_keep=[], genes_fish=[], additional_genes=558):
        ...
        corruption_probability_0_1, corruption_probability_1_0 = corruption_probabilities[0], corruption_probabilities[1]
